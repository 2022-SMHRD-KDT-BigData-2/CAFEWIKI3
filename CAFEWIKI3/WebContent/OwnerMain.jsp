...
<button type="button" onclick="location.href='logoutCon'">로그아웃</button>
	...
	<div id="board">
		...
		%>
		<button id="btn1" type="button" onclick="location.href='cafe.do'">My Page</button>

		<button id="btn2" type="button" onclick="location.href='BarcodeScan.jsp?o_num=<%=vo.getO_num()%>'">쿠폰 관리</button>

		<button id="btn3" type="button" onclick="location.href='customerManage.do'">내 회원 관리</button>

		<button id="btn4" type="button" onclick="location.href='update.do'">정보 수정</button>
</body>
</html>